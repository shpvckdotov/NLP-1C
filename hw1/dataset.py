...
class IMDBDataset(Dataset):
    def __init__(self, positive_path: str, negative_path: str, tokenizer, max_length: int = 512):
    ...
    def __getitem__(self, idx):
        ...
        if pad_len > 0:
            input_ids = input_ids + [self.tokenizer.token_to_idx[self.tokenizer.pad_token]] * pad_len
